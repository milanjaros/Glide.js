...
;(function ($, window, document, undefined) {
	...
	Glide.prototype.build = function() {
		...
		/**
		 * Circular
		 * If circular option is true and there is more than one slide
		 * Append left and right arrow
		 */
		if (this.options.circular & this.slides.length > 1) this.circular();

		/**
		 * Arrows
		 * If arrows option is true and there is more than one slide
		 * Append left and right arrow
		 */
		if (this.options.arrows & this.slides.length > 1) this.arrows();

		/**
		 * Navigation
		 * If navigation option is true and there is more than one slide
		 * Append navigation item for each slide
		 */
		if (this.options.navigation & this.slides.length > 1) this.navigation();
	...
	Glide.prototype.circular = function() {
		 ...
		 */
		var firstClone = this.slides.filter(':first-child').clone().width(this.slides.spread),
			lastClone = this.slides.filter(':last-child').clone().width(this.slides.spread);
		 ...
		 */
		this.wrapper.append(firstClone).prepend(lastClone)
	...
	Glide.prototype.navigation = function() {
		...
		this.navigation.items = new Object();
	...
	Glide.prototype.bindings = function() {
		...
		this.wrapper.bind({
			...
			'setTransition': function() {
				$(this).css( prefix + 'transition', o.animationProperty + ' ' + o.animationDuration + 'ms ' + o.animationTimingFunc);
			},
			...
			'clearTransition': function() {
				$(this).css( prefix + 'transition-duration', '0ms');
			},
			...
			'setTranslate': function(event, translate) {
				...
				if (this.cssSupport) $(this).css( prefix + 'transform', 'translate3d(' + translate + 'px, 0px, 0px)');
	...
	*/
	 ...
	 * @param  {Function} callback
	 */
	Glide.prototype.timeout = function(callback) {
		setTimeout(function(){
			callback();
	...
	Glide.prototype.init = function() {
		...
		// Set wrapper width
		this.wrapper.width(this.slides.spread * this.slides.length);
		// Set slide width
		this.slides.width(this.slides.spread);

		// If CSS3 Transition isn't supported switch cssSupport variable to false and use $.animate()
		if ( !this.css.isSupported("transition") || !this.css.isSupported("transform") ) this.cssSupport = false;
